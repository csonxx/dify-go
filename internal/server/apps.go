...
func (s *server) mountAppRoutes(r chi.Router) {
	...
	r.Get("/apps/{appID}/conversation-variables", s.handleConversationVariablesCurrentValues)
	r.Get("/apps/{appID}/annotations/count", s.handleAnnotationsCount)
	r.Post("/apps/{appID}/annotations", s.handleAppAnnotationsUpsert)
	r.Delete("/apps/{appID}/annotations/{annotationID}", s.handleAppAnnotationDelete)
	r.Post("/apps/{appID}/feedbacks", s.handleAppFeedbacks)
	r.Get("/apps/{appID}/chat-conversations", s.handleChatConversations)
	r.Get("/apps/{appID}/chat-conversations/{conversationID}", s.handleChatConversationDetail)
	r.Get("/apps/{appID}/completion-conversations", s.handleCompletionConversations)
	r.Get("/apps/{appID}/completion-conversations/{conversationID}", s.handleCompletionConversationDetail)
	r.Get("/apps/{appID}/workflow-app-logs", s.handleWorkflowAppLogs)
	r.Get("/apps/{appID}/chat-messages", s.handleAppChatMessages)
	r.Get("/apps/{appID}/server", s.handleMCPServerGet)
	r.Post("/apps/{appID}/server", s.handleMCPServerCreate)
	r.Put("/apps/{appID}/server", s.handleMCPServerUpdate)
	r.Get("/apps/{appID}/server/refresh", s.handleMCPServerRefresh)
	...
	r.Delete("/apps/{appID}/workflows/draft/variables", s.handleWorkflowDraftVariablesDelete)
	r.Delete("/apps/{appID}/workflows/draft/variables/{varID}", s.handleWorkflowDraftVariableDelete)
	r.Put("/apps/{appID}/workflows/draft/variables/{varID}/reset", s.handleWorkflowDraftVariableReset)
	r.Get("/apps/{appID}/workflows/draft/nodes/{nodeID}/variables", s.handleWorkflowDraftNodeVariables)
	r.Delete("/apps/{appID}/workflows/draft/nodes/{nodeID}/variables", s.handleWorkflowDraftNodeVariablesDelete)
	r.Get("/apps/{appID}/workflows/draft/nodes/{nodeID}/last-run", s.handleWorkflowDraftNodeLastRun)
	r.Post("/apps/{appID}/workflows/draft/nodes/{nodeID}/run", s.handleWorkflowDraftNodeRun)
	r.Post("/apps/{appID}/workflows/draft/nodes/{nodeID}/trigger/run", s.handleWorkflowDraftNodeTriggerRun)
	r.Post("/apps/{appID}/workflows/draft/iteration/nodes/{nodeID}/run", s.handleWorkflowDraftIterationNodeRun)
	r.Post("/apps/{appID}/advanced-chat/workflows/draft/iteration/nodes/{nodeID}/run", s.handleWorkflowDraftIterationNodeRun)
	r.Post("/apps/{appID}/workflows/draft/loop/nodes/{nodeID}/run", s.handleWorkflowDraftLoopNodeRun)
	r.Post("/apps/{appID}/advanced-chat/workflows/draft/loop/nodes/{nodeID}/run", s.handleWorkflowDraftLoopNodeRun)
	r.Post("/apps/{appID}/workflows/draft/features", s.handleWorkflowDraftFeaturesUpdate)
	r.Post("/apps/{appID}/workflows/draft/run", s.handleWorkflowDraftRun)
	r.Post("/apps/{appID}/advanced-chat/workflows/draft/run", s.handleWorkflowDraftRun)
	r.Post("/apps/{appID}/workflows/draft/trigger/run", s.handleWorkflowDraftTriggerRun)
	r.Post("/apps/{appID}/workflows/draft/trigger/run-all", s.handleWorkflowDraftTriggerRunAll)
	...
	r.Get("/apps/{appID}/workflows", s.handleWorkflowVersionList)
	r.Post("/apps/{appID}/workflows/{versionID}/restore", s.handleWorkflowVersionRestore)
	r.Patch("/apps/{appID}/workflows/{versionID}", s.handleWorkflowVersionUpdate)
	r.Delete("/apps/{appID}/workflows/{versionID}", s.handleWorkflowVersionDelete)
	r.Get("/apps/{appID}/workflow-runs", s.handleWorkflowRunHistory)
	r.Get("/apps/{appID}/advanced-chat/workflow-runs", s.handleWorkflowRunHistory)
	r.Post("/apps/{appID}/workflow-runs/tasks/{taskID}/stop", s.handleWorkflowRunStop)
	r.Get("/apps/{appID}/workflow-runs/{runID}/node-executions", s.handleWorkflowRunNodeExecutions)
	r.Get("/apps/{appID}/workflow-runs/{runID}", s.handleWorkflowRunDetail)
}
